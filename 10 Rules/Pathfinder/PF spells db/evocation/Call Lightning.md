...
Subschool: 
Aspects: [ electricity ]
ClassList: { druid: 3, shaman: 3, occultist: 3 }
CastTime: 1 round
...
Deity: 
SLALevel: 3
Domains: { Catastrophe: 3, Weather: 3 }
GPCost: 
Bloodline: 
Patron: { Storms: 6 }
Augment: 
...
Meditative: 
Copyright:
  Content: "[PFRPG Core](http://www.d20pfsrd.com/magic/all-spells/c/call-lightning)"
---
Brief:: Calls down lightning bolts (3d6 per bolt) from sky.
